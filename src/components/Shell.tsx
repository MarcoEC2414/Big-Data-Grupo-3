...
export function Shell({
  ...
  const { esAdmin: perfilAdmin } = useAccessControl();
  const [open, setOpen] = useState(false);
  const puedeAdministrar = esAdmin || perfilAdmin;
  const navItems = puedeAdministrar ? [...NAV, { to: "/admin", label: "Administrador", icon: ShieldCheck } as const] : NAV;
