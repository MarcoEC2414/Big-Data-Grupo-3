...
const BADGE_COLORS: Record<string, string> = {
  coincidencia: 'bg-green-500/15 text-green-400 hover:bg-green-500/15',
  diferencia: 'bg-amber-500/15 text-amber-400 hover:bg-amber-500/15',
  faltante_csv: 'bg-red-500/15 text-red-400 hover:bg-red-500/15',
  faltante_firebase: 'bg-purple-500/15 text-purple-400 hover:bg-purple-500/15',
};
                        ...
                        <div className="space-y-4">
                                  ...
                                  >
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                      <div>
                                        ...
                                        <p className="text-sm font-mono bg-blue-500/10 p-2 rounded text-blue-300">
                                      ...
                                      <div>
                                        ...
                                        <p className="text-sm font-mono bg-amber-500/10 p-2 rounded text-amber-300">
                          ...
                          {item.firebaseRecord && (
                            <div>
                              ...
                              <div className="bg-blue-500/10 p-4 rounded border border-blue-500/20 overflow-auto max-h-48">
                          ...
                          {item.csvRecord && (
                            <div>
                              ...
                              <div className="bg-amber-500/10 p-4 rounded border border-amber-500/20 overflow-auto max-h-48">
